...
public class CheckDigit
{
   ...
   {   
	...
	int x = getCheck(numWithCheckDigit/10);
		if(numWithCheckDigit%10 == x) {
			return true;
		}
...
/*
OPEN-ENDED SECTION
I would created a private boolean which would keep track of wether isValid has been called
Then I would right a method called hasIsValidReturnFalse which would return if the IsValid methods has been called
Then If if Isvalid has been called and the resulst were false I would add one to the total incorrect digit checks
