...
public class CardGameGUI extends JFrame implements ActionListener {
	...
	private JButton legalButton;
	
	private JButton possibleButton;
...
/*		
		...
		panel.add(legalButton);
		legalButton.setBounds(BUTTON_LEFT, BUTTON_TOP + BUTTON_HEIGHT_INC,
										100, 60);
		legalButton.addActionListener(this);
		
		possibleButton = new JButton();
		restartButton.setText("possible");
		panel.add(possibleButton);
		possibleButton.setBounds(BUTTON_LEFT, BUTTON_TOP + BUTTON_HEIGHT_INC,
										100, 90);
		possibleButton.addActionListener(this);
*/
